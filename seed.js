...
*/
  seeder.connect('mongodb+srv://123123jkt:Jsdfge123RETE@cluster0.laflv.mongodb.net/db_bwamernbe?retryWrites=true&w=majority', {
  ...
  // seeder.clearModels(['Category', 'Bank', 'Item', 'Member', 'Item', 'Feature', 'Image', 'Booking', 'Users'], function () {
    seeder.clearModels(['Category', 'Item', 'Image', 'Feature', 'Activity', 'Booking', 'Member', 'Bank', 'Users'], function () {
